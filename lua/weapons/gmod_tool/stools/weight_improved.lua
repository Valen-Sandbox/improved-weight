...
if ( CLIENT ) then
	...
	--]]--
	net.Receive( mode.."_notif", function()
	...
	--]]--
	net.Receive( mode.."_error", function()
	...
	--]]--
	cvars.AddChangeCallback( mode.."_tooltip_scale", function( _, _, new )
		new = tonumber( new )
	...
	local function buildCPanel( cpanel )
		...
		for code in pairs( localify.GetLocalizations() ) do
	...
	cvars.AddChangeCallback( "localify_language", function()
